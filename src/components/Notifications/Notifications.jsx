            ...
            {isLoggedIn && (
                <>
                    <div className={styles["header"]}>
                        <p>Notifications</p>
                        {notifications?.length !== 0 && <button className={styles["all-clear-button"]}
                                                                onClick={clearAllNotifications}>Clear</button>}
                    </div>
                    <div>
                                ...
                                notifications.map((item, index) => (
                                    <ul key={index} className={styles["item"]}>
                                        <div className={styles["item-header"]}>
                                            ...
                                            <button className={styles["item-clear-button"]}
                                                    onClick={() => clearNotification(index)}>x
                                            </button>
                                        </div>
